export const scorecardData = {
  categories: [
      ...
      subCategories: [
        {
          name: "Virtualization",
          questions: [
            { id: "2.01", text: "Backups of virtualized workloads occur without the need to deploy or manage proxies", weight: 3},
            { id: "2.02", text: "Auto-discovery and auto-protection of virtualized workloads", weight: 3},
            { id: "2.03", text: "Ability to recover virtualized workloads instantly in-place or in an isolated environment", weight: 3},
            { id: "2.04", text: "Automatically deploy agents for file indexing and cyber monitoring", weight: 3}
          ]
        },
        {
          name: "Database",
          questions: [
            { id: "2.05", text: "Protect databases without the need to write custom scripts", weight: 3},
            { id: "2.06", text: "Protect databases through native APIs, not a 'dump and scrape'", weight: 3},
            { id: "2.07", text: "Automatically discover and protect new and existing databases on a database host", weight: 3},
            { id: "2.08", text: "Protect database logs alongside database to allow point-in-time recovery", weight: 3},
            { id: "2.09", text: "Instantly recover database in-place or live mount with a zero-byte copy on a new database host", weight: 3},
            { id: "2.10", text: "Enable quick database zero-byte copies for test/dev environments", weight: 3},
            { id: "2.11", text: "Quickly recover entire database or granular recovery of only the data required", weight: 3},
            { id: "2.12", text: "Centralized management of database protection irregardless of database engine", weight: 3}
          ]
        },
        {
          name: "Unstructured",
          questions: [
            { id: "2.13", text: "Automatically discover, scan, index and move billions of files across any unstructured data source, including cloud data stores", weight: 3},
            { id: "2.14", text: "Ability to process NAS data in parallel streams with an incrimental forever approach", weight: 3},
            { id: "2.15", text: "Manage NAS backups in the same interface as other datacenter, cloud and SaaS protection", weight: 3},
            { id: "2.16", text: "Leverage modern data protection strategies with NAS sources, relying on vendor APIs instead of legacy protocols", weight: 3},
            { id: "2.17", text: "Leverage any archival or recovery location and change at any time to most cost effective storage tier", weight: 3}
          ]
        }
      ]
    },
    {
      ...
      icon: "☁️",
      questions: [
          { id: "3.01", text: "The data protection solution leverages native cloud APIs to orchestrate protection and recovery", weight: 3 },
          { id: "3.02", text: "Backups can be stored in user determined storage tiers. There is no requirement to follow the cloud providers data tiering requirements", weight: 3 },
          { id: "3.03", text: "Authentication to the cloud leverages a least-privilege model and is configured by an easy-to-follow wizard", weight: 3 },
          { id: "3.04", text: "Data protection solution does not store cloud credentials", weight: 3 },
          { id: "3.05", text: "Data protection solution does not require administrator credentials to protect cloud native workloads", weight: 3 },
          { id: "3.06", text: "Data protection solution does not require infrastructure to be deployed in the customer cloud environment", weight: 2 },
          { id: "3.07", text: "Data protection solution leverages ephemeral compute to calculate hashes, index files all from within the customer's cloud account", weight: 3 },
      ],
      subCategories: [
        {
          name: "AWS",
          questions: [
            { id: "3.08", text: "Backups are able to be stored outside of the AWS Organization, providing a logical air-gap", weight: 3},
            { id: "3.09", text: "Automate the autentication of data protection solution via a CloudFormation template", weight: 3},
            { id: "3.10", text: "As additional workloads are supported by the data protection solution, adding support in the user account is a simple update to the CloudFormation template", weight: 3},
            { id: "3.11", text: "Ephmemeral compute resources are centrally deployed by the data protection solution, leveraging elastic Kuberenetes service", weight: 3},
            { id: "3.12", text: "Restoration of EC2 or RDS instances can be done across regions, accounts or organizations", weight: 3},
            { id: "3.13", text: "Scan and index all objects in protected S3 buckets, providing for granular file/object level recovery", weight: 3},
            { id: "3.14", text: "Data protection solution provides single interface to protect EC2, RDS, S3, EKS, FSxW, FSxN and VMC-A workloads", weight: 3}
          ]
        },
        {
          name: "Azure",
